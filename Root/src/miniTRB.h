...
float GetClusterMIPCharge(cluster clus) { return sqrt(GetClusterSignal(clus) / MIP_ADC); }

float GetSeedMIPCharge(cluster clus) { return sqrt(GetClusterSeedADC(clus) / MIP_ADC); }
