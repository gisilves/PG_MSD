...
int main(int argc, char* argv[]) {
    ...
    for (int entry = 0; entry < nEntries; ++entry) {
        ...
        for (int d = 0; d < nDetectors; ++d) {
            for (int ch = 0; ch < nChannels && ch < (int)detectorData[d]->size(); ++ch) {
                ...
                if (!ChannelMask(ch) && value > 5.0 * sigma) {  // Using 5 sigma threshold
                    hasHits = true;
    ...
    std::string output_filename_report = outputDir + "/" + input_file_base + "_report.pdf";
    ...
    try {
        ...
        TLatex pageNum;
        pageNum.SetNDC(true);
        pageNum.SetTextSize(0.025);
        pageNum.SetTextAlign(31);
        ...
        TLatex pageNum3;
        pageNum3.SetNDC(true);
        pageNum3.SetTextSize(0.025);
        pageNum3.SetTextAlign(31);
        pageNum3.DrawLatex(0.95, 0.03, "Page 3");
        ...
        TLatex pageNum4;
        pageNum4.SetNDC(true);
        pageNum4.SetTextSize(0.025);
        pageNum4.SetTextAlign(31);
        pageNum4.DrawLatex(0.95, 0.03, "Page 4");
        ...
        TLatex pageNum5;
        pageNum5.SetNDC(true);
        pageNum5.SetTextSize(0.025);
        pageNum5.SetTextAlign(31);
        pageNum5.DrawLatex(0.95, 0.03, "Page 5");
        ...
        TLatex pageNum6;
        pageNum6.SetNDC(true);
        pageNum6.SetTextSize(0.025);
        pageNum6.SetTextAlign(31);
        pageNum6.DrawLatex(0.95, 0.03, "Page 6");
        ...
        TLatex pageNum7;
        pageNum7.SetNDC(true);
        pageNum7.SetTextSize(0.025);
        pageNum7.SetTextAlign(31);
        pageNum7.DrawLatex(0.95, 0.03, "Page 7");
        ...
        TLatex pageNum8;
        pageNum8.SetNDC(true);
        pageNum8.SetTextSize(0.025);
        pageNum8.SetTextAlign(31);
        pageNum8.DrawLatex(0.95, 0.03, "Page 8");

        c_amplitude->Update();
        c_amplitude->SaveAs(output_filename_report.c_str());

        // Page 9: Baseline and Sigma vs channel
        ...
        c_baseline_sigma->cd();
        TLatex pageNum9;
        pageNum9.SetNDC(true);
        pageNum9.SetTextSize(0.025);
        pageNum9.SetTextAlign(31);
        pageNum9.DrawLatex(0.95, 0.03, "Page 9");
